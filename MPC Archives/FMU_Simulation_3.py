...
'''
This function is being called by Julia MPC (MPC_S V3.jl) through PyCall. The fmu function 
...
def fmu(iteration, states, commands, time_points):
    ...
    try:
        ...
        model.set("hybrid_2024_controller_new.modular_SOC_Manager1.hysteresis[1].uLow", 0) # This is for the hot PCM. The orginal value was set to 0.5.
        model.set("hybrid_2024_controller_new.modular_SOC_Manager1.hysteresis[1].uHigh", 0.01) # This is for the hot PCM. The orginal value was set to 0.98.
        model.set("hybrid_2024_controller_new.modular_SOC_Manager1.hysteresis[2].uLow", 0) # This is for the cold PCM. The orginal value was set to 0.5.
        model.set("hybrid_2024_controller_new.modular_SOC_Manager1.hysteresis[2].uHigh", 0.01) # This is for the cold PCM. The orginal value was set to 0.98.
