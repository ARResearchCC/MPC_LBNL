# Model Predictive Control: LBNL Simulation. Version 1.0
# Complete Date: 06/04/2024
...
begin
    # Initialize M_States
    global current_m_states = DataFrame(Indoor_Temp = [(71-32)*(5/9)+273.15], PCM_Hot_SOC = [1], PCM_Cold_SOC = [1]);
...
runtime = @elapsed begin
    for i = TimeStart:f_run:NumRun
        ...
        res = FMU.fmu(i, input_schedule, timepoints)
